                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          const Icon(Icons.camera_alt_outlined, size: 36, color: Color(0xFFD1D5DB)),
                          const SizedBox(height: 8),
                          Text(
                            'Tap here or choose from gallery',
                            style: GoogleFonts.nunito(fontSize: 13, color: const Color(0xFF9CA3AF), fontWeight: FontWeight.w600),
                          ),
                        ],
                      ),
                    ),
